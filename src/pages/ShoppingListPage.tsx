...
import { Stack, Title, Text, Group, Card, Paper, List, LoadingOverlay, Button } from '@mantine/core'
    ...
    <Stack gap="lg" pos="relative">
      ...
      {shoppingList.length === 0 ? (
        <Card withBorder p="xl" style={{ textAlign: 'center' }}>
          ...
          <Text c="dimmed" mb="lg">
            Добавьте рецепты в корзину, чтобы автоматически сгенерировать список покупок
          </Text>
        ...
        <>
          ...
          <Card withBorder p="md" style={{ backgroundColor: 'var(--mantine-color-amber-0)' }}>
            <Group gap="md" align="flex-start">
              ...
              <div style={{ flex: 1 }}>
                <Text fw={500} mb="xs">Как использовать список покупок:</Text>
                <Text size="sm" c="dimmed">
                  • Этот список автоматически генерируется на основе рецептов в корзине<br/>
                  • Отметьте купленные товары, кликнув на них<br/>
                  • Экспортируйте список в PDF для удобства<br/>
                  • Список обновляется при изменении корзины
                </Text>
              </div>
            </Group>
          </Card>
          ...
          <Paper p="md" withBorder>
            ...
            <List 
              icon={<CheckCircleFillIcon size={16} fill="var(--mantine-color-sage-8)" />}
              spacing="sm"
            >
